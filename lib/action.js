...
module.exports = async function(context, api) {
  // Debugging: Log the API object
  console.log('API object:', api);

  if (!api || typeof api.checks !== 'object' || typeof api.checks.listForRef !== 'function') {
    console.error('Invalid or undefined API object. Please ensure it is correctly initialized and passed.');
